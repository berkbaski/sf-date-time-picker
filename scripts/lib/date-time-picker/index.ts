...
export class DateTimePicker {
    ...
    createDatePicker(options: IDatePicker): FlexLayout | Dialog {
        ...
        const flDayPicker = this.createPickerLayout({ picker: dayPicker, label: global.lang.day });
        const flMonthPicker = this.createPickerLayout({ picker: monthPicker, label: global.lang.month });
        const flYearPicker = this.createPickerLayout({ picker: yearPicker, label: global.lang.year });
    ...
    createHourPicker(options: IHourPicker): FlexLayout | Dialog {
        ...
        const flHourPicker = this.createPickerLayout({ picker: hourPicker, label: global.lang.hour });
        const flMinutePicker = this.createPickerLayout({ picker: minutePicker, label: global.lang.minute });
